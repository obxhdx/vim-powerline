...
let g:Powerline#Colorschemes#minimal#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['fileinfo.flags'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['currenttag', 'fullcurrenttag', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup', 'extra:indicators', 'extra:tabs'], {
		\ 'n': ['gray8', 'gray2'],
